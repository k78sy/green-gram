        ...
        <div class="container">
            <form class="py-5 d-flex flex-column gap-3" @submit.prevent="submit">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control valid" id="uid" placeholder="아이디" v-model="state.data.uid"
                        not-null-message="아이디는 필수로 입력하셔야 합니다." regexp="^[A-Za-z0-9_]{4,50}$"
                ...
                <div class="form-floating">
                    ...
                    <input type="password" class="form-control valid" id="upw" placeholder="비밀번호"
                        v-model="state.data.upw" not-null-message="비밀번호는 필수로 입력하셔야 합니다."
                ...
                <div class="form-floating">
                    <input type="password" class="form-control" id="chkUpw" placeholder="비밀번호 확인" v-model="state.chkUpw"
                        autocomplete="off" />
                    <label for="chkUpw" class="form-label">비밀번호 확인</label>
                </div>
                <div class="form-floating">
                    <input type="text" class="form-control valid" id="nickName" placeholder="닉네임"
                        v-model="state.data.nm" not-null-message="닉네임은 필수로 입력하셔야 합니다." regexp="^[가-힣]{2,10}$"
                        regexp-message="닉네임은 한글로 2~10자까지 가능합니다." />
                    <label for="nickName" class="form-label">닉네임</label>
                </div>
                <div>
                    <b-button variant="outline-primary" @click="openFileSelector">프로필 사진</b-button>
                    <input ref="fileInput" hidden id="pic" type="file" accept="image/*" @change="handlePicChanged" />
